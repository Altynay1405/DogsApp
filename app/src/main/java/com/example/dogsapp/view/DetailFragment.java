...
public class   DetailFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null){
            dogUuid = DetailFragmentArgs.fromBundle(getArguments()).getDogUuid(); //passing dogUuid args to list fragment

        }

        viewModel = ViewModelProviders.of(this).get(DetailViewModel.class); //instantiate viewModel
